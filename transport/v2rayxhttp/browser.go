...
func ChromeVersion() int {
	...
	var timeDiff int = int((timeCurrent - timeStart - 35)) - int(math.Floor(mrand.Float64()*mrand.Float64()*105))
...
func CurlVersion() string {
	...
	var timeDiff int = int((timeCurrent - timeStart - 60)) - int(math.Floor(mrand.Float64()*mrand.Float64()*165))
