...
var _ congestion.CongestionControl = (*BrutalSender)(nil)

// OnCongestionEventEx implements congestion.CongestionControlEx. Brutal only
// needs the extended ack/loss statistics, so it is safe to install a
// BrutalSender anywhere a plain CongestionControl is accepted.
