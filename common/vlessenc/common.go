...
// Package vlessenc implements the VLESS encryption layer, ported from
// Xray-core proxy/vless/encryption (ML-KEM-768 + X25519 post-quantum
// transport encryption with optional 0-RTT session resumption).
//
// The wire format, nonce derivation, AEAD contexts, padding rules and
// TLS 1.3 record masquerading are kept byte-for-byte identical to Xray.
