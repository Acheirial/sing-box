...
type DialQuicFn func(ctx context.Context) (net.PacketConn, *squic.Conn, error)

type L4Client struct {
	dialFn     DialQuicFn
	runLock    *semaphore.Weighted
	runCtx     context.Context
	clientConn *shttp3.ClientConn
}
...
func (c *L4Client) closeConn(clientConn *shttp3.ClientConn) error {
...
func (c *L4Client) dialConn(ctx context.Context) (*shttp3.ClientConn, error) {
...
func (c *l4StreamConn) quicConn() *squic.Conn {
	return *(**squic.Conn)(unsafe.Pointer(c.clientConn)) // the first field of the shttp3.ClientConn is a *squic.Conn
}
